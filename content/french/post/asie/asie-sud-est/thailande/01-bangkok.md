...
> " En 2019, chaque week-end, il compte plus de 15 000 stands et plus de 11 500 fournisseurs pour plus de 200 000 visiteurs."
...
{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/big-market"
  zoomable="true" Command="" width="" webp="true">}}

Si Bangkok compte pas mal de marchés, c’est aussi (et surtout ?) la ville des centres commerciaux. On en dénombre tellement que j’ai arrêté de les compter. Moi qui d’habitude déteste faire les magasins (petite dédicace à ma chère mère qui par trop de fois aura pu le constater), je me suis surpris à y flâner de longues heures, voire toute une après-midi alors que j’avais pourtant d’autres plans. C’est pas de ma faute si tout y est si bien agencé, si tout y est propre et bien fichu. Un peu comme à l’image du centre-ville quoi.

{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/mall"
  zoomable="true" Command="" width="" webp="true">}}
...
{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/temples-1"
  zoomable="true" Command="" width="" webp="true">}}
...
{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/temples-2"
  zoomable="true" Command="" width="" webp="true">}}
...
{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/chinatown-1"
  zoomable="true" Command="" width="" webp="true">}}

{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/chinatown-2"
  zoomable="true" Command="" width="" webp="true">}}

Mais Chinatown c’est avant tout un grand quartier qui a un style un peu différent du reste de la ville, dans lequel j’ai bien aimé errer au hasard.

{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/chinatown-3"
  zoomable="true" Command="" width="" webp="true">}}

À Bangkok on peut trouver du Street Art un peu partout sur les murs. Ça donne un côté coloré et jovial que j’aime beaucoup.

{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/street-art"
  zoomable="true" Command="" width="" webp="true">}}

Je crois que les Thaïlandais sont borderline fanatiques de leur roi. En tout cas l’omniprésence de ses portraits partout dans la ville m’amène à le penser. On peut aussi trouver des portraits de gens qui doivent être de sa famille, mais ça je le suppose simplement car je n’en ai jamais eu la confirmation.

{{< 
  gallery 
  dir="images/post/asie/asie-sud-est/02-thailande/01-bangkok/royal-portraits"
  zoomable="true" Command="" width="" webp="true">}}

Là-bas tout le monde portait le masque partout dans les lieux publics. Tout le monde sauf… les occidentaux et les indiens. Parfois j’ai un peu honte de faire partie du vieux continent quand je vois que beaucoup n’y mettent pas du leur pour tenter de faire comme les locaux. Je pense par ailleurs que la Thaïlande a eu un contrôle très strict du COVID parce qu’on pouvait trouver partout à l’entrée des magasins des bornes de prise de température.

En se promenant dans la ville on peut y trouver tout plein de choses intéressantes comme :

- Des trucs bien fichus : des ports USB pour recharger son téléphone aux abris-bus. Les abris-bus ne sont d’ailleurs pas détériorés, à nouveau un aspect dont pourraient prendre exemple les un chiffre de notre pays (chiffre comme le nombre nécessaire pour indiquer leur QI).

{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_008.webp"
  caption="" 
  resize=""
  position="center"
  zoomable="true"
...
- Des trucs rigolos comme cette échelle en bambou :

{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_052.webp"
  caption="" 
  resize=""
  position="center"
  zoomable="true"
...
- Des vendeurs de rue qui dorment. Saurez-vous le trouver sur cette image ?

{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_vendeur_qui_dort.webp"
  caption="" 
  resize=""
  position="center"
  zoomable="true"
...
Des chats un peu partout. Ils semblent être largement tolérés (peut-être le côté bouddhiste ?) et on peut les trouver au hasard en train d’errer ou de se prélasser. Je les retrouverai tout le long de mon voyage dans ce pays et même juste après en Malaisie ! Décidément ces petits félins ont la côte chez beaucoup d’habitants de la planète.
<!-- todo LINK MALAISIE -->

{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_001.webp"
  caption="" 
  resize=""
  position="center"
  zoomable="true"
...
{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_067.webp"
  caption="Assurément ma plus belle prise photo de tout mon séjour là-bas. << Capturé >> en pleine journée à Chinatown" 
  resize=""
  position="center"
  zoomable="true"
  command="fill" option="q100" class="img-fluid" title=""
...
- Comme au Vietnam, les gens se couvrent intégralement pour échapper au soleil :

{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_062.webp"
  caption="" 
  resize=""
  position="center"
  zoomable="true"
...
- Quand il pleut très fort, les employés municipaux balaient… l’eau de pluie !

{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_068.webp"
  caption="" 
  resize=""
  position="center"
  zoomable="true"
...
Enfin c’était aussi l’occasion pour moi de découvrir mes premiers plats typiques thailandais :

{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_037.webp"
  caption="Curry vert : mon plat thaïlandais préféré" 
  resize=""
  position="center"
  zoomable="true"
  command="fill" option="q100" class="img-fluid" title=""
...
{{< 
  image src="images/post/asie/asie-sud-est/02-thailande/01-bangkok/bangkok_035.webp"
  caption="Khao Soi : nouilles au curry du nord de la Thaïlande" 
  resize=""
  position="center"
  zoomable="true"
  command="fill" option="q100" class="img-fluid" title=""
